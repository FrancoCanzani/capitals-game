...
export default function AnswerInput({
  ...
  return (
    <form className='flex max-w-xl flex-col justify-between gap-1'>
        ...
        {answer &&
          answer
            ...
            .map((letter, index) => (
              <span
                key={index}
                className={`mr-1 p-1 h-4 w-4 transition-opacity duration-500 transform max-w-full flex items-center justify-center uppercase shadow-sm text-sm font-semibold ${
