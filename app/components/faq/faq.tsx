...
export default function Faq() {
  return (
    <section className="transition-all duration-500 max-w-2xl flex flex-col py-4 mt-8 lg:mx-auto items-start">
      <h2 className="font-semibold w-full border-b">F.A.Q</h2>
      <FAQuestion
