    ...
    <section>
      ...
      <div className='p-8 xl:px-52'>
        ...
        <p className='mb-2'>
          ...
          game. By accessing or using the game, you agree to be bound by these
          Terms. If you do not agree to these Terms, please do not use the game.
        </p>

        <h2 className='text-xl font-semibold mt-4 mb-2'>User Accounts</h2>
        <p className='mb-2'>
          To use certain features of the game, you may be required to create a
          user account. You are responsible for maintaining the confidentiality
          of your account information, including your username and password. You
        ...
        <p className='mb-2'>
          You agree to use the game in accordance with all applicable laws and
        ...
        <ul className='list-disc ml-8'>
          ...
          <li>
            Engage in any form of harassment, hate speech, or harmful conduct;
          </li>
        </ul>

        <h2 className='text-xl font-semibold mt-4 mb-2'>Disclaimer</h2>
        <p className='mb-2'>
          The game is provided &quot;as is&quot; without any warranties, express
          or implied. We do not guarantee the accuracy or availability of the
        ...
        <p className='mb-2'>
          ...
          effective immediately upon posting the revised Terms. Your continued
          use of the game after the posting of the revised Terms constitutes
          your agreement to abide by them.
        </p>

        <p className='text-sm text-gray-600 mt-4'>Last updated: 29-08-2023</p>
      </div>
    </section>
  );
}
